...
class PassengerCar(task.Car):
	...
	def add_remont_book(self, detal, year_replace):
		self.remont_book[detal] = year_replace
        self.detal = detal

	def get_remont_book(self):
		return self.remont_book[self.detal]

Object = PassengerCar()
Object.add_remont_book("Жопа", 1200)
print(Object.get_remont_book())
